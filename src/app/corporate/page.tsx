...
const infoItems = [
  ...
  { date: "2026.02.15", tag: "実績", text: "継続的なご相談をいただく案件が増えています。" },
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between px-[clamp(20px,3vw,40px)] py-5 mix-blend-difference">
        <Link href="/" className="flex items-center gap-2 text-white font-black text-base tracking-wide no-underline">
